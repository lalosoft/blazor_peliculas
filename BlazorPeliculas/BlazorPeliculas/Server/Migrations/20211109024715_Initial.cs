        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PelicualId = table.Column<int>(type: "int", nullable: false),
                    PeliculaId = table.Column<int>(type: "int", nullable: true),
                    Personaje = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Orden = table.Column<int>(type: "int", nullable: false),
                    PeliculaActorPelicualId = table.Column<int>(type: "int", nullable: true),
                    PeliculaActorPersonaId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PeliculasActores", x => new { x.PelicualId, x.PersonaId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_PeliculasActores_PeliculasActores_PeliculaActorPelicualId_PeliculaActorPersonaId",
                        columns: x => new { x.PeliculaActorPelicualId, x.PeliculaActorPersonaId },
                        principalTable: "PeliculasActores",
                        principalColumns: new[] { "PelicualId", "PersonaId" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PeliculasActores_PeliculaActorPelicualId_PeliculaActorPersonaId",
                table: "PeliculasActores",
                columns: new[] { "PeliculaActorPelicualId", "PeliculaActorPersonaId" });
