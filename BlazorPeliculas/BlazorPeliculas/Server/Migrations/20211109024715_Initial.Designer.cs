...
namespace BlazorPeliculas.Server.Migrations
{
    ...
    [Migration("20211109024715_Initial")]
            ...
            modelBuilder.Entity("BlazorPeliculas.Shared.Entidades.PeliculaActor", b =>
                {
                    ...
                    b.Property<int?>("PeliculaActorPelicualId")
                        .HasColumnType("int");

                    b.Property<int?>("PeliculaActorPersonaId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("PelicualId", "PersonaId");

                    b.HasIndex("PeliculaId");

                    b.HasIndex("PersonaId");

                    b.HasIndex("PeliculaActorPelicualId", "PeliculaActorPersonaId");
            ...
            modelBuilder.Entity("BlazorPeliculas.Shared.Entidades.PeliculaActor", b =>
                {
                    ...
                    b.HasOne("BlazorPeliculas.Shared.Entidades.PeliculaActor", null)
                        .WithMany("PeliculasActor")
                        .HasForeignKey("PeliculaActorPelicualId", "PeliculaActorPersonaId");
